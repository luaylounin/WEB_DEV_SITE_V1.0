...
INSERT INTO `order_detail` (`id`, `uid`, `name`, `model`, `price`, `memory`, `storage`, `graphics`, `processor`, `os`, `display`, `image`, `date`) VALUES
(16, 12, 'Dell Vostro', 'DL99022', '967.83', '8 GB', '512 GB SSD', 'Integrated 2GB Graphics', 'Intel Core i3 11 Gen', 'Windows 11', 'Full HD (1920 x 1080)', 'dell vostro.jpg', '12-12-23');
