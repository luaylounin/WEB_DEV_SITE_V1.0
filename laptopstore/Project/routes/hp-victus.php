...
<div id="bodySection">
        ...
        <div class="row p-3">
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="../uploads/hp victus.jpg" height="500" width="500">
                    </div>
                    <div class="col-md-6">
                        <h1 id="title">HP Victus</h1>
                        <br>
                        <p>
                            <b>Processor: </b><br>
                            Ryzen 5 5600H <br>
                        ...
                        <h2 id="title"><i class="fa fa-eur" aria-hidden="true"></i>869.00</h2><br>
                        <div id="buy-now">
        ...
        <div class="row p-3">
           ...
           <div class="col-md-1"></div>
            ...
            <div class="col-md-10">
                ...
                <div class="row p-4">
                    <div class="col-md-4">
                        <img src="../uploads/hp victus 1.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/hp victus 2.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/hp victus 3.jpg" height="300" width="300">
                    </div>
                </div>
                <div class="row p-4">
                    <div class="col-md-4">
                        <img src="../uploads/hp victus 4.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/hp victus 5.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/hp victus 6.jpg" height="300" width="300">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="row p-1">
                                ...
                                <div class="col-md-6">
                                    <i class="fa fa-eur" aria-hidden="true"></i>869.00
                                </div>
                        </div>
                        <div class="row p-1">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-6">
                                    <i class="fa fa-eur" aria-hidden="true"></i>156.42
                                </div>
                        </div>
                        <div class="row p-1">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-6">
                                    <i class="fa fa-eur" aria-hidden="true"></i>25
                                </div>
                        </div>
                        <div class="row p-1">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-6">
                                    <h5><b><i class="fa fa-eur" aria-hidden="true"></i>1050.42</b></h5>
                                </div>
                        </div>
                        <br>
                        <form action="../api/order.php" method="post">
                            ...
                            <input type="hidden" name="laptop-name" value="HP Victus">
                            <input type="hidden" name="laptop-model" value="HP65422">
                            <input type="hidden" name="laptop-price" value="1050.42">
                            ...
                            <input type="hidden" name="laptop-image" value="hp victus.jpg">
