...
<div id="bodySection">
        ...
        <div class="row p-3">
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="../uploads/asus tuf.jpg" height="500" width="500">
                    </div>
                    <div class="col-md-6">
                        <h1 id="title">Asus Tuf A15</h1>
                        <br>
                        <p>
                            <b>Processor: </b><br>
                            Ryzen 7 4800H <br>
                            ...
                            NVIDIA RTX 3050 4GB Graphics Card <br> 
                        ...
                        <h2 id="title"><i class="fa fa-eur" aria-hidden="true"></i>1,000.00</h2><br>
                        <div id="buy-now">
                ...
                <div class="p-4">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                            <th>Graphics Card</th>
                            <td>Dedicated NVIDIA RTX 3050</td>
        ...
        <div class="row p-3">
           ...
           <div class="col-md-1"></div>
            ...
            <div class="col-md-10">
                ...
                <div class="row p-4">
                    <div class="col-md-4">
                        <img src="../uploads/asus tuf 1.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/asus tuf 2.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/asus tuf 3.jpg" height="300" width="300">
                    </div>
                </div>
                <div class="row p-4">
                    <div class="col-md-4">
                        <img src="../uploads/asus tuf 4.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/asus tuf 5.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/asus tuf 6.jpg" height="300" width="300">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="row p-1">
                                ...
                                <div class="col-md-6">
                                    <i class="fa fa-eur" aria-hidden="true"></i>1,000.00
                                </div>
                        </div>
                        <div class="row p-1">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-6">
                                    <i class="fa fa-eur" aria-hidden="true">180.00</i>
                                </div>
                        </div>
                        <div class="row p-1">
                                <div class="col-md-5">
                        ...
                        <div class="row p-1">
                                ...
                                <div class="col-md-6">
                                    <h5><b><i class="fa fa-eur" aria-hidden="true"></i>1,205.00</b></h5>
                                </div>
                        </div>
                        <br>
                        <form action="../api/order.php" method="post">
                            ...
                            <input type="hidden" name="laptop-name" value="Asus Tuf A15">
                            <input type="hidden" name="laptop-model" value="AS052422">
                            <input type="hidden" name="laptop-price" value="1,205.00">
                            <input type="hidden" name="laptop-memory" value="8 GB">
                            <input type="hidden" name="laptop-storage" value="512 GB SSD">
                            <input type="hidden" name="laptop-graphics" value="Dedicated NVIDIA RTX 3050 4 GB Graphics">
                            <input type="hidden" name="laptop-processor" value="Ryzen 7 4600H">
                            <input type="hidden" name="laptop-os" value="Windows 11">
                            <input type="hidden" name="laptop-display" value="Full HD (1920 x 1080)">
                            <input type="hidden" name="laptop-image" value="asus tuf.jpg">
