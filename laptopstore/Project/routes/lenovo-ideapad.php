...
<div id="bodySection">
        ...
        <div class="row p-3">
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="../uploads/lenovo ideapad.jpg" height="500" width="500">
                    </div>
                    <div class="col-md-6">
                        <h1 id="title">Lenovo Ideapad</h1>
                        <br>
                        <p>
                            <b>Processor: </b><br>
                        ...
                        <h2 id="title"><i class="fa fa-eur" aria-hidden="true"></i>859.00</h2><br>
                        <div id="buy-now">
        ...
        <div class="row p-3">
           ...
           <div class="col-md-1"></div>
            ...
            <div class="col-md-10">
                ...
                <div class="row p-4">
                    <div class="col-md-4">
                        <img src="../uploads/lenovo ideapad 1.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/lenovo ideapad 2.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/lenovo ideapad 3.jpg" height="300" width="300">
                    </div>
                </div>
                <div class="row p-4">
                    <div class="col-md-4">
                        <img src="../uploads/lenovo ideapad 4.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/lenovo ideapad 5.jpg" height="300" width="300">
                    </div>
                    <div class="col-md-4">
                        <img src="../uploads/lenovo ideapad 6.jpg" height="300" width="300">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="row p-1">
                                ...
                                <div class="col-md-6">
                                    <i class="fa fa-eur" aria-hidden="true"></i>859.00
                                </div>
                        </div>
                        <div class="row p-1">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-6">
                                    <i class="fa fa-eur" aria-hidden="true"></i>154.62
                                </div>
                        </div>
                        <div class="row p-1">
                                <div class="col-md-5">
                        ...
                        <div class="row p-1">
                                ...
                                <div class="col-md-6">
                                    <h5><b><i class="fa fa-eur" aria-hidden="true"></i>1,038.62</b></h5>
                                </div>
                        </div>
                        <br>
                        <form action="../api/order.php" method="post">
                            ...
                            <input type="hidden" name="laptop-name" value="Lenovo Ideapad">
                            <input type="hidden" name="laptop-model" value="LNV05722">
                            <input type="hidden" name="laptop-price" value="1,038.62">
                            ...
                            <input type="hidden" name="laptop-image" value="lenovo ideapad.jpg">
